...
namespace Sriracha.Deploy.Data.Tests.Tasks.XmlConfigFile
{
	...
	public class XmlConfigFileTaskExecutorTests
	{
		...
		public void ExecuteWithValidConfiguration_CreatesXmlFiles()
		{
			...
			testData.TaskExecutor.Execute(testData.DeployStateId, testData.StatusManager.Object, testData.TaskDefinition, testData.Component, testData.EnvironmentComponent, testData.EnvironmentComponent.MachineList.First(), testData.RuntimeSystemSettings);
