...
namespace Sriracha.Deploy.Data.Tests.Tasks.LocalCommandLine
{
	...
	public class LocalCommandLineTaskExecutorTests
	{
		...
		public void ExecuteWithValidConfiguration_CallsProcessRunner()
		{
			...
			var result = testData.TaskExecutor.Execute(testData.DeployStateId, testData.StatusManager.Object, testData.TaskDefinition, testData.EnvironmentComponent, testData.RuntimeSystemSettings);
