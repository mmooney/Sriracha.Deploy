...
namespace Sriracha.Deploy.Web.Controllers
{
    public class PreviewEmailController : Controller
    {
		...
		public PreviewEmailController(IDeployRepository deployRepository, ISystemSettings systemSettings, IUrlGenerator urlGenerator, IRazorTemplateRepository razorTemplateRepository)
		{
