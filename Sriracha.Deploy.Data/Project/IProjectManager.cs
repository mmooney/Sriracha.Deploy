...
namespace Sriracha.Deploy.Data.Project
{
	public interface IProjectManager
	{
		...
		DeployEnvironment CreateEnvironment(string projectId, string environmentName, IEnumerable<DeployEnvironmentConfiguration> componentList, IEnumerable<DeployEnvironmentConfiguration> configurationList, string deploymentCredentialsUserName);
